...
* Abilita la gestione colore con Adobe Color Engine (ACE) nelle Preferenze di Designer.
...
> **Colori miniature**
> 
> Le miniature dei nodi sono *non gestite dal colore per impostazione predefinita*, pertanto la visualizzazione del colore nel vista 2D con il profilo corretto è considerata affidabile. La gestione del colore delle miniature può essere attivata nelle preferenze di Gestione colore del progetto, ma ha un leggero costo in termini di prestazioni.
