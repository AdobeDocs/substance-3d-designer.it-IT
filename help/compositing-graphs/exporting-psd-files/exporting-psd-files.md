...
La finestra di dialogo Esportazione PSD può essere aperta solo con un metodo. Nella [vista Grafico](../../interface/the-graph-view/the-graph-view.md) del grafico che si desidera esportare in PSD, fare clic sul pulsante ![](exporting-psd-files.resources/image2019-9-17-14-44-17.png) <b>Strumenti</b> e selezionare <b>PSD Exporter</b>. L&#39;interfaccia diventa visibile nella <b>visualizzazione Grafico</b>.
