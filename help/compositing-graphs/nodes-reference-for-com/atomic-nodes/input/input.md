...
I parametri di base includono, tra gli altri, <b>Dimensioni output</b>, <b>Formato output</b> e <b>Modalità affiancamento</b>.
...
![Input primario nel grafico Substance](input.resources/node-primary-input.png)
...
>[!IMPORTANT]
>
> Il metodo di ereditarietà *relativo all&#39;input* per i nodi di input è *non supportato* in [risorse Substance 3D (SBSAR)](../../../publishing-asset-files/publishing-substance-3d-asset-files-sbsar.md). Imposta tutti i metodi di ereditarietà dei nodi di input su *Rispetto all&#39;elemento padre* prima di pubblicare il pacchetto.

## Attributi integrazione

Gli input non vengono inviati direttamente al vista 3D, ma i relativi attributi di utilizzo vengono utilizzati da [Substance 3D Painter](https://experienceleague.adobe.com/en/docs/substance-3d-painter/using/home) per riempire automaticamente gli slot con determinate mappe (utilizzati principalmente con [filtri](https://experienceleague.adobe.com/en/docs/substance-3d-painter/using/effects/filter)).
