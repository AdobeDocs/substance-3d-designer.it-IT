...
![Nodo atomico: Normale](normal.resources/comp_normal_1.png "Nodo atomico: Normale"){width="200px"}
...
|  |  |
| --- | --- |
| <b>Intensità</b> *Mobile* | Modifica l’intensità della mappa dell’altezza.   Consente di impostare l’intensità di interpretazione della mappa dell’altezza di input per la conversione in valori normali. A seconda delle mappe di input, i valori superiori a 100 hanno un effetto leggermente maggiore. |
