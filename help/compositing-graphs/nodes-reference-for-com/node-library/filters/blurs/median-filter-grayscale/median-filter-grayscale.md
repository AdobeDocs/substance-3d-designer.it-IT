...
|  |  |
|:---|:---|
| <b>Input</b> <i>Scala di grigi</i> | Immagine in scala di grigio a cui deve essere applicato il filtro. |
...
|  |  |
|:---|:---|
| <b>Output</b> <i>Scala di grigi</i> | Immagine in scala di grigio calcolata applicando il filtro all’immagine in scala di grigio di input. |
