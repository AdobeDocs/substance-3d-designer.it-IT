...
| <b>Modalità fotocamera</b> *Numero intero* | Metodo di proiezione della scena sull&#39;immagine di rendering:<br><br>- <b>Prospettiva:</b> Questa proiezione trasmette profondità e abilita effetti obiettivo come la profondità del campo.<br>- <b>Ortografica:</b> Questa proiezione appiattisce la scena, annullando la profondità.<br>- <b>Funzione personalizzata:</b> Creare un grafico delle funzioni per impostare una fotocamera personalizzata. |
| <b>Funzione videocamera</b> *Float3* | Grafico a funzioni che definisce la trasformazione della videocamera. Questa opzione può essere utilizzata per configurare una videocamera personalizzata.<br><br>La funzione deve <b>impostare</b> le seguenti variabili:<br>- <code>view.origin</code> (Float3) Posizione dello spazio mondo per pixel della visualizzazione della fotocamera.<br>- <code>view.direction</code> (Float3) Il vettore in avanti per pixel della vista della videocamera, in base alla modalità di proiezione. (E.g. prospettiva o ortografica)<br><br>Le seguenti variabili sono disponibili per <b>get</b>:<br>- <code>camera.origin</code> (Float3) Posizione dello spazio globale della fotocamera. (camera.direction * camera_distance + camera.target)<br>- <code>camera.direction</code> (Float3) La direzione dello spazio mondo della fotocamera, ovvero il vettore Y-forward della fotocamera.<br>- <code>fotocamera.right</code> (Float3) Vettore X-right della fotocamera.<br>- <code>camera.up</code> (Float3) Vettore Z-up della fotocamera.<br>- <code>camera.target</code> (Float3) Posizione dello spazio globale della fotocamera di destinazione. |
| <b>Posizione UV</b> *Float2* | La posizione nello spazio dell&#39;immagine 2D utilizzata per dedurre la posizione e la direzione della fotocamera in orbita attorno alla <b>posizione di destinazione</b>.<br><br><i>Suggerimento:</i> Questo parametro può essere regolato in modo intuitivo utilizzando il <i>gizmo posizione</i> disponibile nella vista 2D quando il nodo è selezionato. |
| <b>FOV</b> *Mobile* | Il campo visivo della videocamera ortogonale (FOV), che influisce sul fattore di zoom. |
| <b>Lunghezza focale</b> *Mobile* | La lunghezza focale della telecamera, che influisce sul fattore di zoom e sulla profondità dell&#39;effetto campo. |
...
| <b>Colore di base</b> *Virgola mobile 3* | Colore di base di default per le superfici in cui il colore non è definito dalla relativa funzione SDF o di intersezione. |
| <b>Rugosità</b> *Virgola mobile* | Valore di default della rugosità per le superfici in cui tale valore non è definito dalla relativa funzione SDF o intersezione. |
| <b>Metallicità</b> *Virgola mobile* | Valore di default della metalness per le superfici in cui tale valore non è definito dalla relativa funzione SDF o di intersezione. |
| <b>Opacità helpers</b> *Virgola mobile* | Opacità degli helper 3D, dove un valore inferiore genera helper sfocati. |
| <b>fotogramma di selezione</b> *Booleano* | Visualizzazione di una gabbia a sei lati che definisce i limiti dell&#39;intera scena. Dovrebbe idealmente essere della dimensione più piccola possibile che includa completamente la scena.<br><br>Utilizzare il parametro <b>Dimensioni fotogramma di delimitazione</b> per regolare le dimensioni della gabbia.<br><br>Il parametro <b>Colora fuori dal fotogramma</b> consente di visualizzare facilmente le superfici esterne a quella gabbia, il che influisce sul risultato dell&#39;utilizzo di quella scena nel nodo [Splatter forma v2](../../../texture-generators/patterns/shape-splatter-v2/shape-splatter-v2.md). (Consulta la descrizione del comando &quot;Dimensioni fotogramma di selezione&quot;) |
| <b>Dimensioni fotogramma di selezione</b> *Virgola mobile 3* | Imposta le dimensioni XYZ del fotogramma di delimitazione.<br><br>Regolare il fotogramma nella scena, quindi applicare gli stessi valori al parametro <b>Dimensione fotogramma associata SDF</b> del nodo [splatter forma v2](../../../texture-generators/patterns/shape-splatter-v2/shape-splatter-v2.md) per garantire che tutte le forme nella scena siano correttamente incluse e disegnate da tale nodo. |
| <b>Colorazione fuori fotogramma</b> *Booleano* | Applica un colore rosso alle superfici esterne al fotogramma di selezione.<br><br>Ciò consente di verificare che la scena sia completamente inclusa nel fotogramma di delimitazione. |
...
| <b>Frequenza isolinee SDF</b> *Virgola mobile* | Quantità di ripetizioni isolinea entro una determinata distanza.<br><br>Un valore più elevato determina linee più dense e sottili. |
| <b>Posizione isolinee SDF</b> *Virgola mobile* | Il height spaziale mondiale del piano XY utilizzato per disegnare le isolinee.<br><br>Utilizzare questa opzione per controllare il campo distanza della forma a varie quote altimetriche. |
