...
![Icona Anisotropica in scala di grigio Kuwahara](bevel-smooth.resources/bevel_smooth.png "Icona anisotropica in scala di grigio Kuwahara"){width="200px"}
...
|  |  |
|:---|:---|
| <b>Input maschera</b> <i>Scala di grigi</i> PRIMARIO | Immagine da cui estrarre la maschera.   Tutti i valori al di sopra del valore &quot;Soglia maschera&quot; sono bianchi nella maschera. |
| <b>Input di origine</b> <i>Scala di grigi</i> | Un input opzionale utilizzato solo quando il parametro &#39;Modalità output&#39; è impostato su &#39;Dilation&#39;.   In tal caso, l’immagine viene sovrapposta sulle aree bianche della maschera e i valori in scala di grigio ai bordi vengono dilatati. |
...
|  |  |
|:---|:---|
| <b>Output</b> <i>Scala di grigi</i> | L&#39;immagine risultante, in base al &quot;Metodo di output&quot; selezionato. |
| <b>UV</b> <i>Colore</i> | Una mappa UV in cui gli UV sono dilatati lungo i bordi della maschera.   Questo può essere collegato a un nodo [UV Mapper](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/spline-tools/uv-mapper-color/uv-mapper-color.md) per mappare qualsiasi altra immagine utilizzando questi UV dilatati. |
...
![Smusso uniforme: Esempio 1](bevel-smooth.resources/bevel_smooth_example_1.gif "Smusso uniforme: Esempio 1"){width="1024px" zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Smusso uniforme: Esempio 8](bevel-smooth.resources/bevel_smooth_example_8.jpg "Smusso uniforme: Esempio 8"){width="1024px" zoomable="yes"}
...
<table>
  <tr>
    <td>
      <img src="bevel-smooth.resources/bevel_smooth_example_4_before.jpg" alt="bevel_smog_example_4_before">
      <br><i>Prima</i>
    </td>
    <td>
      <img src="bevel-smooth.resources/bevel_smooth_example_4_after.jpg" alt="bevel_smog_example_4_after">
      <br><i>Dopo</i>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td>
      <img src="bevel-smooth.resources/bevel_smooth_example_2_before.jpg" alt="bevel_smog_example_2_before">
      <br><i>Prima</i>
    </td>
    <td>
      <img src="bevel-smooth.resources/bevel_smooth_example_2_after.jpg" alt="bevel_smog_example_2_after">
      <br><i>Dopo</i>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td>
      <img src="bevel-smooth.resources/bevel_smooth_example_3_before.jpg" alt="bevel_smog_example_3_before">
      <br><i>Prima</i>
    </td>
    <td>
      <img src="bevel-smooth.resources/bevel_smooth_example_3_after.jpg" alt="bevel_smog_example_3_after">
      <br><i>Dopo</i>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td>
      <img src="bevel-smooth.resources/bevel_smooth_example_5_before.jpg" alt="bevel_smog_example_5_before">
      <br><i>Prima</i>
    </td>
    <td>
      <img src="bevel-smooth.resources/bevel_smooth_example_5_after.jpg" alt="bevel_smog_example_5_after">
      <br><i>Dopo</i>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td>
      <img src="bevel-smooth.resources/bevel_smooth_example_7_before.jpg" alt="bevel_smog_example_7_before">
      <br><i>Prima</i>
    </td>
    <td>
      <img src="bevel-smooth.resources/bevel_smooth_example_7_after.jpg" alt="bevel_smog_example_7_after">
      <br><i>Dopo</i>
    </td>
  </tr>
</table>
