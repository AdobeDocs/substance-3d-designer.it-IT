...
![Icona nodo](scatter-on-spline-color.resources/scatter-on-spline-color-icon.png "Icona nodo")
...
| <b>Mappa Height</b> <i>Scala di grigi</i> | La mappa che controlla il height dei pattern sparsi. L’effetto di questa mappa è controllato dal parametro &quot;Moltiplicatore di input di Height&quot; ed è combinato con gli altri parametri &quot;Colore&quot; del gruppo &quot;Colore&quot;. |
...
| <b>Inizio</b> <i>Virgola mobile</i> | Sposta il punto dall&#39;inizio di una spline nel punto in cui inizia la dispersione. Il valore è la lunghezza normalizzata di ogni spline. |
| <b>Fine</b> <i>Virgola mobile</i> | Sposta il punto dall&#39;inizio di una spline nel punto in cui termina la dispersione. Il valore è la lunghezza normalizzata di ogni spline. |
| <b>Pivot forma</b> <i>Virgola mobile 2</i> | Sposta il perno della serie X e Y nello spazio tangente della spline.<br>Considerando che il perno è ciò che viene posizionato sulla spline, questo sposta efficacemente i pattern lungo o perpendicolarmente alla spline.<br>Nota: le posizioni dei perni influiscono sull&#39;effetto dei parametri &quot;Scala&quot; e &quot;Rotazione (pivot)&quot;. |
| <b>Pattern</b> |  |
...
| <b>Rotazione</b> <i>Virgola mobile</i> | Ruota il cerchio virtuale lungo il quale vengono distribuiti i duplicati. |
| <b>Attenuazione inizio/fine offset</b> <i>Virgola mobile 2</i> | Fattori nella distanza dal punto medio della spline al suo inizio e alla sua fine, quando si applicano offset ai duplicati.<br>Ciò significa che gli scostamenti vengono ridotti per i duplicati più vicini alle estremità di una spline. |
...
| <b>Posizione</b> |  |
| <b>Offset locale</b> <i>Virgola mobile 2</i> | Applica uno scostamento alle posizioni delle serie lungo la tangente (parallela) e la normale (perpendicolare) della spline. |
| <b>Scostamento locale casuale</b> <i>Virgola mobile 2</i> | Applica un ulteriore scostamento casuale alle posizioni delle serie lungo la tangente (parallela) e la normale (perpendicolare) della spline. |
| <b>Centro casuale scostamento locale</b> <i>Virgola mobile 2</i> | Sposta il centro dello scostamento casuale applicato dal parametro Scostamento casuale locale (Local Offset Random) lungo la tangente (parallela) e la normale (perpendicolare) della spline. |
| <b>Attenuazione inizio/fine scostamento locale</b> <i>Virgola mobile 2</i> | Fattori nella distanza dal punto medio della spline al suo inizio e alla sua fine quando si applicano scostamenti di posizione ai pattern.<br>Ciò significa che gli scostamenti vengono diminuiti per i pattern più vicini alle estremità di una spline. |
| <b>Attenuazione offset locale per Thickness</b> <i>Virgola mobile</i> | Fattori nel thickness della spline quando si applicano gli scostamenti ai pattern.<br>Ciò significa che gli scostamenti vengono ridotti per i duplicati su una porzione di una spline con un thickness inferiore. |
| <b>Scostamento sulla spline</b> <i>Virgola mobile</i> | Applica uno scostamento di posizione ai pattern lungo le spline. |
| <b>Scostamento casuale sulla spline</b> <i>Virgola mobile</i> | Applica uno scostamento di posizione aggiuntivo ai pattern lungo le spline. |
| <b>Rotazione</b> |  |
...
| <b>Colore base forma</b> <i>Float4</i> | Colore di base dei pattern. |
| <b>Moltiplicatore input colore</b> <i>Mobile</i> | Controlla l’intensità dell’input Mappa colori. Questa mappa funge da moltiplicatore per il colore corrente dei pattern.<br>L&#39;effetto di questa mappa è combinato con gli altri parametri nel gruppo &quot;Colore&quot;.<br>Nota: il colore di output è il risultato ponderato di tutti i moltiplicatori di colore. |
...
| <b>Colore casuale</b> <i>Float4</i> | Applica uno scostamento casuale fino ai valori specificati ai colori dei pattern nello spazio HSV, nonché al loro canale alfa.<br>*Nota:* Il colore di output è il risultato ponderato di tutti i moltiplicatori di colore. |
...
| <b>Moltiplicatore Indice Forma</b> <i>Mobile</i> | Intensità per la quale l&#39;alfa di ogni pattern viene moltiplicato rispetto all&#39;indice normalizzato.<br>Nota: il colore di output è il risultato ponderato di tutti i moltiplicatori di colore. |
| <b>Moltiplicatore Height spline</b> <i>Mobile</i> | Intensità per la quale l&#39;alfa di ogni pattern viene moltiplicato rispetto al height della spline nella relativa posizione.<br>Nota: il colore di output è il risultato ponderato di tutti i moltiplicatori di colore. |
| <b>Luminanza casuale</b> <i>Mobile</i> | Applica un moltiplicatore casuale fino al valore specificato per diminuire il valore alfa dei pattern.<br>Nota: il colore di output è il risultato ponderato di tutti i moltiplicatori di colore. |
...
<table>
  <tr>
    <td>
      <img src="scatter-on-spline-color.resources/ScatterOnSplineGrayscale-Variant1-Before.jpg" alt="ScatterOnSplineGreyscale-Variant1-Before">
      <br><i>Prima</i>
    </td>
    <td>
...
<table>
  <tr>
    <td>
      <img src="scatter-on-spline-color.resources/ScatterOnSplineGrayscale-Variant2-Before.jpg" alt="ScatterOnSplineGreyscale-Variant2-Before">
      <br><i>Prima</i>
    </td>
    <td>
...
![Esempio di nodo 1](scatter-on-spline-color.resources/ScatterOnSplineGrayscale-Demo.gif "Esempio di nodo 1")

</td>
<td style="border: 0;" valign="top">

![Esempio di nodo 2](scatter-on-spline-color.resources/ScatterOnSplineColor-Demo.gif "Esempio di nodo 2")
