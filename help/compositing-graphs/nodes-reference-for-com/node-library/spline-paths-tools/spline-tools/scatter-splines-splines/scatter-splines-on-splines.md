...
|  |  |
| --- | --- |
| <b>Lato</b> *Numero intero* | Determina i lati delle spline padre da spargere, considerando che la direzione delle spline *padre* è &#39;forward&#39;: a sinistra Posizionare le spline sul lato sinistro.   A destra Posizionare le spline sul lato destro.   Sinistra + Destra Posizionate le spline su entrambi i lati.   Sinistra/Destra - L’opzione Posizione alternativa splina a sinistra e poi a destra in modo alternativo (ad esempio, ogni altro lato).   Sinistra/Destra (Left/Right) - Consente di selezionare casualmente il lato di ogni spline. |
| <b>Modalità quantità</b> *Numero intero* | Metodo di dispersione delle spline lungo le spline padre, che influisce sulla quantità di spline sparse su ciascuna spline padre: quantità fissa per spline La quantità specificata di spline distribuite uniformemente viene distribuita.   Spaziatura La quantità di spline viene regolata automaticamente per adattarsi alla spaziatura uniforme specificata.   In entrambi i casi, la prima e l&#39;ultima spline sparsa si trovano esattamente all&#39;inizio e alla fine di ciascuna spline padre. |
...
| <b>Tipo spline</b> *Numero intero* | Seleziona il tipo di spline da spargere sulle spline padre: Dritta Una spline semplice e dritta.   Spline personalizzata Spline fornite agli input <b>Spline personalizzata</b>. Sono supportate più spline aggiunte insieme a un elenco. |
| <b>Selezione spline personalizzata</b> *Numero intero* | Quando si utilizzano più spline personalizzate accodate in un elenco, questo parametro consente di selezionare la modalità di distribuzione di tali spline nella dispersione.   Elenco intero Tutte le spline vengono sparse insieme come gruppo.   Sequenziale Ogni singola spline è distribuita in ordine, facendo un ciclo attorno all&#39;elenco.   Casuale Una spline casuale viene selezionata dall&#39;elenco per ogni spline dispersa. |
...
| <b>Modalità simmetria sinistra/destra</b> *Numero intero* | Metodo di simmetria applicato alle spline sparse su ciascun lato delle spline padre.   Disattivato Non viene applicata alcuna simmetria, le spline vengono posizionate su ciascun lato utilizzando una semplice rotazione.   Simmetria sinistra La spline a sinistra è simmetrica rispetto a quella a destra relativamente alla spline padre.   Simmetria destra La spline a destra è simmetrica rispetto a quella a sinistra rispetto alla spline padre. |
| <b>Collegamento casuale sinistro/destro</b> *Booleano* | Controlla se le spline su ciascun lato della spline principale devono utilizzare gli stessi valori quando si utilizzano la rotazione casuale, il ridimensionamento casuale e così via. In altre parole: *- False:* ogni spline utilizza valori casuali separati *- True:* entrambe le spline condividono gli stessi valori casuali |
| <b>Modalità pivot spline</b> *Numero intero* | Imposta il metodo di posizionamento del perno delle spline sparse, che influisce sulla rotazione e sul ridimensionamento.   Si noti che il perno è *sempre posizionato sulla spline padre* e i relativi controlli influiscono sulla spline dispersa. In altre parole: il perno non si muove, è la spline sparsa che si muove e si ridimensiona relativamente ad esso.   Posizionare lungo la spline Spostare il perno lungo la spline sparsa.   Posizione assoluta Impostare una posizione arbitraria per il perno. |
...
| <b>Modalità campionamento input mappa scala</b> *Numero intero* | Metodo di mappatura dei valori nella <b>Mappa scala</b> alle spline: Spazio texture I valori vengono applicati alle spline nella posizione in cui si troverebbero se inseriti in una texture utilizzando le coordinate UV della texture. Questo applica efficacemente il valore alle spline &quot;in posizione&quot; Orizzontali lungo la spline. I valori vengono applicati direttamente alle coordinate delle spline codificate (vedere l&#39;input <b>Coord spline</b>), in cui ogni riga viene applicata a una spline diversa dall&#39;alto verso il basso. lungo spline (rand. offset X) I valori vengono applicati direttamente alle coordinate delle spline codificate (vedere l&#39;input <b>Coord spline</b>), con uno scostamento orizzontale casuale nella <b>Mappa scala</b> per ogni spline (ovvero ogni riga in <b>Coord spline</b>) Hor. lungo spline (rand. offset Y) I valori vengono applicati direttamente alle coordinate delle spline codificate (vedere l&#39;input <b>Coord spline</b>), con uno scostamento verticale casuale nella <b>Mappa scala</b> per ogni spline (ovvero, ogni riga nelle <b>Coord spline</b>) |
| <b>Attenuazione inizio/fine</b> *Float2* | Fattori nella distanza dal punto medio della spline al suo <b>Inizio</b> e <b>Fine</b> durante il ridimensionamento delle spline.   Ciò significa che le dimensioni vengono ridotte per le spline più vicine alle estremità di una spline. |
...
| <b>Scostamento su intervallo spline</b> *Numero intero* | Imposta l&#39;intervallo di scostamento applicato alle spline sparse lungo le spline padre.   Intervallo L&#39;intervallo si estende nell&#39;intervallo *tra* ogni spline dispersa.   Spline padre L&#39;intervallo si estende per *tutta la lunghezza* della spline padre. |
| <b>Scostamento sulla spline</b> *Mobile* | Applica uno scostamento di posizione alle spline lungo le spline padre. |
| <b>Intervallo scostamento casuale</b> *Numero intero* | Imposta l&#39;intervallo di scostamento casuale applicato alle spline sparse lungo le spline padre.   Intervallo L&#39;intervallo si estende nell&#39;intervallo *tra* ogni spline dispersa.   Spline padre L&#39;intervallo si estende per *tutta la lunghezza* della spline padre. |
...
| <b>Scostamento in base al Thickness</b> *Mobile* | Applica uno scostamento alle spline sparse lungo la normale delle spline padre, fino al thickness delle spline padre.   In effetti, il valore 1 consente di posizionare le spline sparse sulla *superficie* dell&#39;inviluppo delle spline padre. |
...
|  |  |
| --- | --- |
| <b>Allineamento spline personalizzato</b> *Numero intero* | Controlla l&#39;orientamento iniziale delle spline personalizzate sulle spline padre.   Prima tangente del punto Le spline vengono orientate in base alla tangente del primo punto. In altre parole, si allontanano dalle spline principali nella direzione impostata dal primo punto.   Spazio immagine Le spline vengono posizionate come appaiono in origine, senza ulteriori regolazioni della loro posizione o orientamento, come se l&#39;immagine che le rappresenta fosse appoggiata sulla spline principale. |
| <b>Modalità di rotazione</b> *Numero intero* | Imposta l&#39;orientamento iniziale delle spline sparse.   Da spline Le spline vengono orientate in modo da corrispondere alla *normale* delle spline padre nella relativa posizione.   Assoluto Le spline vengono orientate tutte allo *stesso modo*, indipendentemente dalla direzione delle spline padre. |
...
| <b>Modalità campionamento input Mappa di rotazione</b> *Numero intero* | Metodo di mappatura dei valori nella <b>Mappa di rotazione</b> alle spline: Spazio della texture I valori vengono applicati alle spline dove si troverebbero se inseriti in una texture utilizzando le coordinate UV della texture. In questo modo il valore viene applicato alle spline &quot;in posizione&quot;, orizzontali lungo la spline. I valori vengono applicati direttamente alle coordinate delle spline codificate (vedere l&#39;input <b>Spline Coords</b>), in cui ogni riga viene applicata a una spline diversa dall&#39;alto verso il basso, Hor. lungo spline (rand. offset X) I valori vengono applicati direttamente alle coordinate delle spline codificate (vedere l&#39;input <b>Coord spline</b>), con uno scostamento orizzontale casuale nella <b>Mappa di rotazione</b> per ogni spline (ovvero, ogni riga in <b>Coord spline</b>).   Ore. lungo spline (rand. offset Y) I valori vengono applicati direttamente alle coordinate delle spline codificate (vedere l&#39;input <b>Spline Coords</b>), con uno scostamento verticale casuale nella <b>Mappa di rotazione</b> per ogni spline (ovvero, ogni riga in <b>Spline Coords</b>)<b>.</b> |
| <b>L&#39;input Mappa di rotazione ha effetto</b> *Numero intero* | Seleziona il parametro di rotazione interessato dalla <b>Mappa di rotazione</b>: Rotazione spline La mappa influisce sulla rotazione globale delle spline in senso orario.   Angolo sinistro/destro La mappa influisce sulla rotazione simmetrica delle spline <b>sinistro/destro</b>. |
...
|  |  |
| --- | --- |
| <b>Avvia modalità Height</b> *Numero intero* | Metodo di calcolo del height iniziale delle spline sparse.   Manuale Impostare lo stesso valore assoluto per tutte le spline sparse.   Da spline padre (+ spline personalizzata) Utilizzare il height della spline padre, quindi aggiungere il height della spline personalizzata utilizzando il gruppo di height iniziale <b>Spline personalizzata.Parametro </b>.   Da spline personalizzata Utilizzare il height della spline personalizzata così com&#39;è.   *Nota:* impostare <b>Spline Type</b> su &#39;Custom Spline&#39; e connettere gli input <b>Custom Spline</b> per utilizzare il height di spline personalizzate. |
| <b>Mult Height iniziale spline personalizzato.</b> *Mobile* | Controlla il contributo del height iniziale della spline personalizzata al height iniziale delle spline sparse, dove 1 indica che viene utilizzato l&#39;intero height della spline personalizzata.   Il height della spline personalizzata viene utilizzato in modo diverso in base alla <b>Modalità Height iniziale</b> selezionata: *- Dalla spline padre (+ spline personalizzata):* Il height viene aggiunto alla spline padre *- Dalla spline personalizzata:* Il height viene utilizzato direttamente |
...
| <b>Modalità Height finale</b> *Numero intero* | Metodo di calcolo del height finale delle spline sparse.   Manuale Impostare lo stesso valore assoluto per tutte le spline sparse.   Da spline padre (+ spline personalizzata) Utilizzare il height della spline padre, quindi aggiungere il height della spline personalizzata utilizzando il <b>insieme di Height finali spline personalizzato.Parametro </b>.   Da spline personalizzata Utilizzare il height della spline personalizzata così com&#39;è.     *Nota:* impostare <b>Spline Type</b> su Custom Spline e collegare gli input <b>Custom Spline</b> per utilizzare il height di spline personalizzate. |
| <b>Mult Height finale spline personalizzato</b> *Mobile* | Controlla il contributo del height finale della spline personalizzata al height finale delle spline sparse, dove 1 indica che viene utilizzato l&#39;intero height della spline personalizzata.   Il height della spline personalizzata viene utilizzato in modo diverso in base alla <b>Modalità Height finale</b> selezionata: *- Dalla spline padre (+ spline personalizzata):* Il height viene aggiunto alla spline padre *- Dalla spline personalizzata:* Il height viene utilizzato direttamente |
...
|  |  |
| --- | --- |
| <b>Avvia modalità Thickness</b> *Numero intero* | Metodo di calcolo del thickness iniziale delle spline sparse.   Manuale Impostare lo stesso valore assoluto per tutte le spline sparse.   Dalla spline padre Utilizzare il thickness della spline padre.   Da spline personalizzata Utilizzare il thickness della spline personalizzata.   *Nota:* impostare <b>Spline Type</b> su Custom Spline e collegare gli input <b>Custom Spline</b> per utilizzare il thickness di spline personalizzate. |
