...
![Icona nodo](../../../../../../assets/spline-sample-height-icon.png "Icona nodo")
...
<b>Mappa Height</b> *Scala di grigio* Immagine in scala di grigio di input utilizzata per modificare il height della spline di input.
...
<b>Modalità campionamento</b> *Intero* Metodo di mappatura dei valori nella mappa di Height alle spline:\
...
<b>Opacità</b> *Fluttuazione* Moltiplicatore per l&#39;intensità del contributo dell&#39;input Mappa Height al height della spline.<b></b>

<b>Metodo fusione</b> *Intero* Metodo di fusione dei dati della mappa del Height con il height della spline di input:\
*- Copia*: sovrascrivere il height della spline con i valori Height della mappa;\
*- Aggiungi*: aggiungi i valori della mappa dei Height al height della spline;\
*- Sottrai*: sottrai i valori della mappa dei Height al height della spline;\
*- Moltiplica*: moltiplica i valori della mappa dei Height sul height della spline.
...
![Esempio di nodo 1](../../../../../../assets/SplineSampleHeight-Variant1-After4.jpg "Esempio di nodo 1")

</td>
<td style="border: 0;" valign="top">

![Esempio di nodo 2](../../../../../../assets/SplineSampleHeight-Demo.gif "Esempio di nodo 2")
