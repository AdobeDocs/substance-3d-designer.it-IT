...
breadcrumb-title: ''
description: Utilizzate il nodo Scala di grigi di mappatura UV per mappare le texture in scala di grigi lungo le spline per la generazione di texture procedurali.
