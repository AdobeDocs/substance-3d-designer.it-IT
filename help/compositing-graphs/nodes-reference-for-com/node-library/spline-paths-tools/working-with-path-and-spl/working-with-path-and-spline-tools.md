...
![Output poligono tracciati](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-01.jpg "Output poligono tracciati")
...
![Spline Cubic nella vista 2D](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-02.gif "Spline Cubic nella vista 2D")
...
![Strumenti di tracciato nella libreria](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-03.jpg "Strumenti di tracciato nella libreria")
...
![Nodi di generazione dei percorsi](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-04.jpg "Nodi di generazione dei percorsi"){width="600px"}
...
![Nodo Anteprima tracciati](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-05.jpg "Nodo Anteprima tracciati")
...
![Percorso della spline](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-06.jpg "Percorso della spline")
...
![Strumenti spline nella libreria](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-07.jpg "Strumenti spline nella libreria")
...
Con [Spline 2D Trasforma](../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/spline-tools/spline-2d-transform/spline-2d-transform.md) e [Spline Warp](../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/spline-tools/spline-warp/spline-warp.md) potete modificare la forma delle spline.
...
![Aggiunta di spline con modalità di creazione del collegamento](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-08.gif "Aggiunta di spline con modalità di creazione del collegamento")
...
![Anteprima output su nodo spline](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-09.jpg "Anteprima output su nodo spline")
...
![Spline sottoposta a rendering come segmenti](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-10.jpg "Spline sottoposta a rendering come segmenti")
