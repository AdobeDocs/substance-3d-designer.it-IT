---
helpx_url: "https://helpx.adobe.com/it/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/directional-noise-4.html"
breadcrumb-title: ''
description: Utilizzate il nodo Disturbo direzionale 4 per generare pattern di disturbo direzionale con quattro ottave per la creazione di texture anisotrope.
...
# DISTURBO DIREZIONALE 4

<table>
<tr style="border: 0;">
<td width="33.33%" style="border: 0;" valign="top">

![Disturbo direzionale 4 - Icona](directional-noise-4.resources/directional_noise_4.png "Disturbo direzionale 4 - Icona"){width="200px"}
...
![Disturbo direzionale 4 - Esempio 1](directional-noise-4.resources/directional_noise_4_1.png "Disturbo direzionale 4 - Esempio 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Disturbo direzionale 4 - Esempio 2](directional-noise-4.resources/noise_directional_noise_4_v2_speed0.6_aniso0.gif "Disturbo direzionale 4 - Esempio 2"){zoomable="yes"}
...
![Disturbo direzionale 4 - Esempio 3](directional-noise-4.resources/noise_directional_noise_4_v2_speed0.6_aniso1.gif "Disturbo direzionale 4 - Esempio 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Disturbo direzionale 4 - Esempio 4](directional-noise-4.resources/noise_directional_noise_4_v2_speed0.3_aniso0.6.gif "Disturbo direzionale 4 - Esempio 4"){zoomable="yes"}
