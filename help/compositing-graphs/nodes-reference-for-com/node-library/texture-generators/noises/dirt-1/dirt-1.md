---
helpx_url: "https://helpx.adobe.com/it/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/dirt-1.html"
breadcrumb-title: ''
description: Utilizzate il nodo Dirt 1 per generare pattern di dirt di base per la creazione di dettagli della superficie usurata e di effetti di accumulo.
...
![Dirt 1 - Icona](dirt-1.resources/dirt_1.png "Dirt 1 - Icona"){width="200px"}
...
![Dirt 1 - Esempio 1](dirt-1.resources/dirt_1_1.png "Dirt 1 - Esempio 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Dirt 1 - Esempio 2](dirt-1.resources/noise_dirt_1_v2_speed0.6_aniso0.gif "Dirt 1 - Esempio 2"){zoomable="yes"}
...
![Dirt 1 - Esempio 3](dirt-1.resources/noise_dirt_1_v2_speed0.6_aniso1.gif "Dirt 1 - Esempio 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Dirt 1 - Esempio 4](dirt-1.resources/noise_dirt_1_v2_speed0.3_aniso0.6.gif "Dirt 1 - Esempio 4"){zoomable="yes"}
