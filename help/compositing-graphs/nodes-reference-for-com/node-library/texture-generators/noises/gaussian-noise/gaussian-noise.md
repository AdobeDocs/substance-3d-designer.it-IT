...
![Rumore gaussiano - Icona](gaussian-noise.resources/gaussian_noise-1.png "Rumore gaussiano - Icona"){width="200px"}
...
![Rumore gaussiano - Esempio 1](gaussian-noise.resources/gaussian_noise-1_1.png "Rumore gaussiano - Esempio 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Rumore gaussiano - Esempio 2](gaussian-noise.resources/noise_gaussian_noise_v2_speed0.6_aniso0.gif "Rumore gaussiano - Esempio 2"){zoomable="yes"}
...
![Rumore gaussiano - Esempio 3](gaussian-noise.resources/noise_gaussian_noise_v2_speed0.6_aniso1.gif "Rumore gaussiano - Esempio 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Rumore gaussiano - Esempio 4](gaussian-noise.resources/noise_gaussian_noise_v2_speed0.3_aniso0.6.gif "Rumore gaussiano - Esempio 4"){zoomable="yes"}
