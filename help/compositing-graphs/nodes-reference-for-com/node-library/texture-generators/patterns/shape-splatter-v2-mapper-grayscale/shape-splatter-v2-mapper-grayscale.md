...
| <b>Funzione personalizzata</b> *Virgola mobile* | Specifica la luminanza per pixel delle forme come Virgola mobile.<br><br>Sono disponibili le seguenti variabili:<br>- <code>shape.position.os</code> (Virgola mobile 3) Posizione della superficie della forma nello spazio dell&#39;oggetto.<br>- <code>shape.position.ws</code> (Virgola mobile 3) Posizione della superficie della forma nello spazio mondo*.<br>- <code>shape.normal.os</code> (Virgola mobile 3) Normali della superficie della forma nello spazio dell&#39;oggetto.<br> - <code>forma.normale.ws</code> (Virgola mobile 3) Normali della superficie della forma nello spazio mondo*.<br>- <code>shape.id</code> (Virgola mobile) identificatore univoco della forma.<br>- <code>material.id</code> (Virgola mobile) L&#39;ID materiale della superficie della forma, definito dal nodo [splatter forma v2](../shape-splatter-v2/shape-splatter-v2.md).<br><br>*: Lo spazio globale della forma è centrato sul relativo perno e non tiene conto del height della forma. Ciò significa che l&#39;unica differenza con lo spazio dell&#39;oggetto è l&#39;orientamento.<br><br>Se è necessario campionare gli input del nodo [Shape splatter v2 mapper grayscale](shape-splatter-v2-mapper-grayscale.md), è possibile utilizzare questi [slot di input del nodo ](../../../../../../function-graphs/nodes-reference-for-fun/atomic-function-nodes/sampler-nodes/sampler-nodes.md) per campionamento in scala di grigi:<br>- 0: Atlante griglia<br>- 1-8: input del modello 1-8 |
