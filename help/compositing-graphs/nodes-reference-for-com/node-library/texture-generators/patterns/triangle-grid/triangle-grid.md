...
| <b>Height casuale</b> *Virgola mobile* | Applica uno scostamento casuale alla posizione Z di ciascun vertice.  Questo offset *stacks* con il parametro <b>Moltiplicatore di input Height</b>. |
| <b>Modalità Fusione</b> *Numero intero* | Imposta il metodo di fusione dei valori di *triangoli sovrapposti*. La modalità consente di selezionare *quali* dei triangoli devono essere visibili: <ul data-preserve-html="true"> <li data-preserve-html="true"><b>Min:</b> Testo</li> <li data-preserve-html="true"><b>Massimo:</b> Testo</li> <li data-preserve-html="true"><b>Profondità test</b>: testo</li> <li data-preserve-html="true"><b>Fusione Alpha:</b> testo</li> </ul>Nota: i metodi di fusione disponibili dipendono dal valore del parametro <b>Output colore</b>. |
