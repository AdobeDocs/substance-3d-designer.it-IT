...
>[!NOTE]
>
> I modelli di grafico disponibili tramite la [finestra di dialogo Nuovo grafico Substance](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/create-a-graph-102400068.html) dispongono di nodi di output predefiniti pronti per l&#39;utilizzo.
...
### ![(errore)](../../assets/error.svg) La funzione del parametro *[x]* contiene alcuni avvisi
...
![Correggere l&#39;avviso &#39;La funzione del parametro contiene alcuni avvisi&#39;](../../assets/warnings-comp-param-function.gif "Correggere l&#39;avviso &#39;La funzione del parametro contiene alcuni avvisi&#39;")
...
Nel pannello [Esplora risorse](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html), individuare la risorsa a cui si fa riferimento e risolvere tutti gli avvisi generati dalla risorsa:
...
![Correzione dell&#39;avviso &#39;I dati di riferimento contengono alcuni avvisi&#39;](../../assets/warnings-comp-referenced-data.gif "Correzione dell&#39;avviso &#39;I dati di riferimento contengono alcuni avvisi&#39;")
...
Trovare le risorse a cui si fa riferimento nel pannello [Esplora risorse](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html) e verificarne la presenza nel percorso salvato nell&#39;attributo **Percorso file**.\
...
### ![(errore)](../../assets/error.svg) Il nodo di testo utilizza un font non valido
