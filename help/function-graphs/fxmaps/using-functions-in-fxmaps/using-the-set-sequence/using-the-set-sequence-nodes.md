...
![Nodi Set e Sequence](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-01.png "Nodi Set e Sequence")
...
![Imposta nodo](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-02.png "Imposta nodo")
...
![Imposta esempio nodo](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-03.png "Imposta esempio nodo")
...
![Nodo sequenza](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-04.png "Nodo sequenza")
...
![Esempio di nodo di sequenza](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-05.png "Esempio di nodo di sequenza")
...
![Nodo sequenza concatenato](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-06.png "Nodo sequenza concatenato")
...
![Proprietà quadrante](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-07.png "Proprietà quadrante")
...
![Funzione Colore/Luminosità del quadrante](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-08.png "Funzione Colore/Luminosità del quadrante")

</td>
</tr>
</table>

![Pattern sparsi](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-09.png "Pattern sparsi")
...
![Menu della funzione dei parametri della rotazione del pattern](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-10.png "Menu della funzione dei parametri della rotazione del pattern")
...
![Output float Get della rotazione del pattern](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-11.png "Output float Get della rotazione del pattern")
...
![Pattern ruotati](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-12.png "Pattern ruotati")
