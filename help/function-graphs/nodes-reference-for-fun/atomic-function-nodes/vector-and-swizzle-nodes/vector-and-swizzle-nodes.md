---
helpx_url: "https://helpx.adobe.com/it/substance-3d-designer/function-graphs/nodes-reference-for-function-graphs/atomic-function-nodes/vector-and-swizzle-nodes.html"
breadcrumb-title: ''
...
* I nodi swizzle **accettano qualsiasi input** del tipo corretto (Int o Float).

### Dividi componenti

Il caso d&#39;uso più comune di Swizzle è quello di usarlo per dividere i componenti, come la frenatura di un Integer4 in 4 singoli Integer. Le limitazioni indicano che saranno necessari quattro nodi Swizzle Integer separati per questa operazione.
...
| --- | --- | --- | --- |
| **Intero Swizzle** | **Ornato** **Intero2** | **Ornato** **Intero3** | **Ornato** **Intero4** |
...
| **Ornato** **Mobile** | **Ornato** **Mobile2** | **Ornato** **Mobile3** | **Ornato** **Mobile4** |
