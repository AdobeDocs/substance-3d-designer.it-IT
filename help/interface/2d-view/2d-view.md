...
Il modo più semplice per visualizzare qualsiasi immagine nella vista 2D consiste nel fare doppio clic su *LMB*...
...
<b>![](../../assets/2d-view-icon-transparency-straight.png) diritto:</b> le informazioni sulla trasparenza vengono memorizzate solo nel canale alfa e non influiscono su altri aspetti dell&#39;immagine

<b>![](../../assets/3d-view-icon-transparency-premultiplied.png) Premoltiplicato:</b> le informazioni sulla trasparenza vengono memorizzate nel canale alfa e influiscono anche sui canali RGB, poiché vengono moltiplicati in modo efficace rispetto al canale alfa
...
>[!TIP]
>
> Per ulteriori informazioni, consultate la pagina [Editor di pittura bitmap](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/bitmap-painting-editor-102400057.html) della documentazione.
...
>[!TIP]
>
> Per ulteriori informazioni, consulta la pagina [Editor di grafica vettoriale (obsoleto)](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/vector-graphic-editor-deprecated-102400059.html) della documentazione.
