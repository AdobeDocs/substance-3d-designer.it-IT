...
[vista 3D](../../../interface/3d-view/3d-view.md) esegue il rendering della superficie dei modelli utilizzando un programma denominato *shader*. Lo shader definisce il materiale
applicato al modello utilizzando un elenco di proprietà che influiscono su vari aspetti dell&#39;aspetto del modello.

Il menu **Materiali** dei vista 3D consente di controllare lo shader utilizzato per ciascuno dei materiali della scena.
...
Le proprietà di questo shader seguono il [riferimento al parametro OpenPBR](https://academysoftwarefoundation.github.io/OpenPBR/#parameterreference) e sono *condivise* attraverso il rasterizzatore,
...
|---------------------------------|---------|----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Affiancamento | A virgola mobile | 1.0 | Quantità di ripetizioni di texture in una cella UV, dove un valore più alto<br/>determina un numero maggiore di ripetizioni di texture. |
| Abilita dimensioni fisiche da grafico | Booleano | False | Regola automaticamente l&#39;Affiancamento in base alla [Dimensioni fisiche](../../../compositing-graphs/graph-parameters/graph-parameters.md)<br/>del grafico per rappresentare il materiale alla scala appropriata. |
| Scala UV | Float2 | 1.0, 1.0 | Regola la scala dell&#39;Affiancamento in base a un fattore separato per U e V, dove <br/>un valore più elevato genera un numero maggiore di ripetizioni di texture. |
...
| Colore | Virgola mobile3 (RGB) | 0.8, 0.8, 0.8 | Colore del riflesso dalla base diffusa e metallica. |
...
| Colore | Virgola mobile3 (RGB) | 1.0, 1.0, 1.0 | Colore del riflesso dello specular. (Controlla la tinta dei bordi fisica per i metalli,<br/>e una tinta complessiva non fisica per i dielettrici) |
...
| Anisotropia | A virgola mobile | 0.0 | La distorsione direzionale della rugosità della base metallica/dielettrica, risultante<br/>in luci sempre più allungamento lungo la direzione tangente. |
...
| Colore | Virgola mobile3 (RGB) | 1.0, 1.0, 1.0 | Controlla il colore della base trasparente dovuto all&#39;assorbimento volumetrico<br/>della legge della birra sotto la superficie. |
...
| A dispersione | Virgola mobile3 (RGB) | 0.0, 0.0, 0.0 | Controlla il colore della luce distribuita volumetricamente all’interno della base trasparente. |
...
| Colore | Virgola mobile3 (RGB) | 0.8, 0.8, 0.8 | Colore del riflesso osservato del mezzo di dispersione della sottosuperficie. |
| Raggio | A virgola mobile | 1.0 | Scala di lunghezza del percorso libero medio di dispersione della sottosuperficie. |
| Scala raggio | Virgola mobile3 (RGB) | 1.0, 0.5, 0.25 | Moltiplicatore RGB a subsurface_radius, che fornisce la dispersione per canale<br/>percorsi medi liberi. |
...
| Colore | Virgola mobile3 (RGB) | 1.0, 1.0, 1.0 | Colore della trasparenza dello strato di rivestimento, dovuto all&#39;assorbimento nel rivestimento. |
...
| Anisotropia | A virgola mobile | 0.0 | Distorsione direzionale della rugosità del livello del rivestimento trasparente,<br/>risultante in luci sempre più allungamento lungo la direzione della tangente del pelo. |
...
| Colore | Virgola mobile3 (RGB) | 1.0, 1.0, 1.0 | Il colore del livello Fuzz. |
...
| Colore | Virgola mobile3 (RGB) | 1.0, 0.0, 0.0 | Il colore della luce emessa. |
...
| Parametro | Tipo | Predefinito | Descrizione |
|-----------|-------|---------|-------------------------------------------------------------------------------------------------------|
| Spessore | A virgola mobile | 0.0 | Peso di copertura del film sottile.<br/>Usare per materiali quali pitture per auto multicolore o bolle di sapone. |
...
| Normale | Virgola mobile3 (RGB) | 0.5, 0.5, 1.0 | Immettete una normale geometrica per la superficie. |
| Tangente | Virgola mobile3 (RGB) | 1.0, 0.5, 0.0 | Immettete una tangente geometrica. |
| Rivestimento normale | Virgola mobile3 (RGB) | 0.5, 0.5, 1.0 | Inserite la normale per lo strato di rivestimento. |
| Tangente rivestimento | Virgola mobile3 (RGB) | 1.0, 0.5, 0.0 | Immettete una tangente geometrica per il livello di rivestimento. |
...
Designer rileva automaticamente alcuni identificatori per garantire la compatibilità con OpenPBR come modello predefinito.
...
Il modello di Adobe Standard Material (ASM) è stato introdotto in Designer 11.2 ed è lo shader predefinito di Designer
...
Modello documentato [qui](https://experienceleague.adobe.com/en/docs/substance-3d/general-knowledge/asm/adobe-standard-material).
