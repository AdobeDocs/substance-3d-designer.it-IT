...
Viene visualizzato facendo clic sul relativo pulsante di attivazione/disattivazione dedicato ![](scene-browser.resources/sceneBrowser-toggleButton.png) nella barra degli strumenti [della scena della vista 3D](../../../interface/3d-view/3d-view.md).

![Browser scene - Scena 3D caricata](scene-browser.resources/loaded3DScene.png "Browser scene - Scena 3D caricata"){zoomable="yes"}
...
![Browser scene - Albero scene](scene-browser.resources/sceneBrowser-sceneTree.png "Browser scene - Albero scene"){zoomable="yes"}
...
![Browser scene - Oggetti aggiunti da Designer elencati in grassetto](scene-browser.resources/sceneBrowser-addedByDesigner.png "Browser scene - Oggetti aggiunti da Designer elencati in grassetto"){zoomable="yes"}
...
È possibile attivare o disattivare la visibilità di un oggetto facendo clic sul relativo pulsante a forma di occhio ![](scene-browser.resources/sceneBrowser-eyeButton.png) o dal relativo menu di scelta rapida. Il menu offre alcune azioni in più per la gestione della visibilità degli oggetti della scena:
...
![Browser scene - Attivazione/disattivazione della visibilità degli oggetti](scene-browser.resources/sceneBrowser-toggleVisibility.gif "Browser scene - Attivazione/disattivazione della visibilità degli oggetti"){zoomable="yes"}
...
![Browser scene - Attivazione/disattivazione della visibilità dell&#39;ambiente](scene-browser.resources/sceneBrowser-toggleEnvLights.gif "Browser scene - Attivazione/disattivazione della visibilità dell&#39;ambiente"){zoomable="yes"}

### Luci

Lo stesso vale per qualsiasi luce nella scena: ciascuna può essere attivata o disattivata singolarmente.

![Browser scene - Attivazione/disattivazione della visibilità delle luci](scene-browser.resources/sceneBrowser-toggleLights.gif "Browser scene - Attivazione/disattivazione della visibilità delle luci"){zoomable="yes"}
...
![Browser scene - Materiale connesso](scene-browser.resources/sceneBrowser-connectedMaterial.png "Browser scene - Materiale connesso"){zoomable="yes"}
