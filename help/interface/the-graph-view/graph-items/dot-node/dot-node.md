...
![Icona nodo punto](dot-node.resources/graphatomic-dot_1.png "Icona nodo punto")
...
![Inserimento di un nodo punto](dot-node.resources/dot-node-insert-optim.gif "Inserimento di un nodo punto"){width="512px"}
...
![Punto: creazione dal connettore](dot-node.resources/graph-dot_create-from-connector.gif "Punto: creazione dal connettore")
...
![Nodo punto nel menu Nodo](dot-node.resources/dot-node-insert-menu.png "Nodo punto nel menu Nodo")
...
![Unione dei collegamenti](dot-node.resources/dot-node-congrenate-links-optim.gif "Unione dei collegamenti"){width="512px"}
...
![Nodo punto come portale - icona](dot-node.resources/DotNode_Portal-1.png "Nodo punto come portale - icona")
...
![Nodo punto come portale](dot-node.resources/DotNode_Portal.gif "Nodo punto come portale")
