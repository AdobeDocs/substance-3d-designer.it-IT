...
![Navigazione viewport](the-graph-view.resources/the-graph-view-01.gif "Navigazione viewport")

<b>focalizza</b> sui nodi selezionati o sull&#39;intero grafico se non è selezionato nulla, con il tasto F.

È possibile eseguire la navigazione anche utilizzando <b>segnaposti di navigazione </b>e la chiave F2, vedere [elementi del grafico](#graph-items) di seguito[.](../../interface/the-graph-view/graph-items/graph-items.md)
...
![Inserimento di nodi](the-graph-view.resources/the-graph-view-02.gif "Inserimento di nodi")
...
![Visualizzazione grafico: menu Nodo](the-graph-view.resources/the-graph-view-03.png "Visualizzazione grafico: menu Nodo")
...
![Selezione dei nodi](the-graph-view.resources/the-graph-view-04.gif "Selezione dei nodi")
...
![Connessione dei nodi](the-graph-view.resources/the-graph-view-05.gif "Connessione dei nodi")
...
* Vengono visualizzati con il badge ![](the-graph-view.resources/the-graph-view-06.png) <b>Disattivato</b>*,* una *struttura tratteggiata* e un collegamento interno *reindirizzamento* anziché una miniatura;
...
![Disabilitazione dei nodi](the-graph-view.resources/the-graph-view-07.gif "Disabilitazione dei nodi"){width="512px"}
...
![](the-graph-view.resources/the-graph-view-08.png) <b>Selezione elemento attivo</b> (F)\
Attiva la vista sulla selezione o l’intera scena se la selezione è vuota.

![](the-graph-view.resources/the-graph-view-09.png) <b>Ripristina zoom</b> (Z)\
...
![](the-graph-view.resources/the-graph-view-10.png) <b>Esporta visualizzazione grafico\
...
![](the-graph-view.resources/the-graph-view-11.png) <b>Informazioni sul nodo\
...
Ricerca nodo ![](the-graph-view.resources/the-graph-view-12.png)<b></b> (CTRL+F)\
...
![](the-graph-view.resources/the-graph-view-13.png) <b>Flusso evidenziazione\
...
![](the-graph-view.resources/the-graph-view-14.png) <b>Palette dei nodi\
</b>Mostra o nasconde la barra degli strumenti del nodo, vedere di seguito.

![](the-graph-view.resources/the-graph-view-15.png) <b>Collegamenti rettangolari\
...
![](the-graph-view.resources/the-graph-view-16.png) <b>Strumenti di allineamento dei nodi\
...
![](the-graph-view.resources/the-graph-view-17.png) <b>Dimensione padre\
</b>Attiva/disattiva la visualizzazione delle impostazioni del controllo Risoluzione principale, vedere di seguito.

![](the-graph-view.resources/the-graph-view-18.png) <b>Modalità di creazione del collegamento</b> (1, 2, 3)\
...
![](the-graph-view.resources/the-graph-view-19.png) <b>Controllo intervalli\
</b>Consente di reimpostare tutti i nodi e tutti gli intervalli.

![](the-graph-view.resources/the-graph-view-20.png) <b>Strumenti\
...
![](the-graph-view.resources/the-graph-view-21.png) <b>Cache immagini nodo\
</b>Attiva/disattiva la visualizzazione della cache delle immagini del nodo, vedere di seguito.

![](the-graph-view.resources/the-graph-view-22.jpg) Rimozione dei nodi inutilizzati\
...
[![Palette dei nodi](the-graph-view.resources/the-graph-view-23.png)](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/atomic-nodes.md)<br>
...
![Tavolozza degli elementi del grafico](the-graph-view.resources/the-graph-view-24.png "Tavolozza degli elementi del grafico")<br>
...
![Tavolozza FX-Map](the-graph-view.resources/the-graph-view-25.png "Tavolozza FX-Map")<br>
...
![Barra degli strumenti dimensioni principale](the-graph-view.resources/the-graph-view-26.png "Barra degli strumenti dimensioni principale")
...
![Impostazione della cache delle immagini dei nodi](the-graph-view.resources/the-graph-view-27.png "Impostazione della cache delle immagini dei nodi")
...
![Rimuovi i nodi inutilizzati dal menu a discesa](the-graph-view.resources/the-graph-view-28.jpg "Rimuovi i nodi inutilizzati dal menu a discesa")
