...
![Libreria](the-library.resources/library-main.png "Libreria")
...
![Eliminazione di un nodo dalla libreria](the-library.resources/library-create-node.gif "Eliminazione di un nodo dalla libreria")
...
È possibile filtrare i risultati della ricerca in base al *tipo di grafico*, utilizzando l&#39;icona ![](the-library.resources/library-icon-search-filter.png) <b>Filtra per...</b> accanto alla barra <b>Ricerca</b>.
...
![Ricerca di risorse nella libreria](the-library.resources/library-search-2.png "Ricerca di risorse nella libreria")
...
Utilizzando il pulsante a discesa ![](the-library.resources/library-icon-view-mode.png) <b>Modalità visualizzazione</b>, è possibile selezionare le dimensioni di visualizzazione per gli elementi di contenuto.

</td>
<td width="25.00%" style="border: 0;" valign="top">

![Modalità visualizzazione risorse libreria](the-library.resources/library-display-modes.png "Modalità visualizzazione risorse libreria")
...
Il pulsante ![](the-library.resources/library-icon-toggle-label.png) **Attiva/disattiva etichette** consente di visualizzare o nascondere le etichette dei nodi.

</td>
<td style="border: 0;" valign="top">

![Alterna etichetta](the-library.resources/library-toggle-label.png "Alterna etichetta")
...
![Descrizione comando informazioni risorsa](the-library.resources/library-item-tooltip.png "Descrizione comando informazioni risorsa")
...
È possibile aggiungere qualsiasi elemento nella sezione <b>Contenuto</b> all&#39;elenco <b>Preferiti</b> utilizzando il pulsante ![](the-library.resources/library-icon-favoritepng.png) <b>Aggiungi a Preferiti</b>. Il pulsante consente inoltre di *rimuovere* contenuto dall&#39;elenco, se è già stato aggiunto.\
...
![Preferiti nella libreria](the-library.resources/library-favourites.png "Preferiti nella libreria")
