...
L&#39;esportazione di un modulo MDL viene eseguita al livello *pacchetto*. Per esportare un modulo MDL per un determinato pacchetto, fare clic sul pulsante ![](exporting-mdl-content.resources/mdl-export-module-icon.png) <b>Esporta modulo MDL</b> in [Esplora risorse](../../interface/the-explorer-window/the-explorer-window.md) o selezionare la stessa opzione nel menu di scelta rapida del *pacchetto*. Selezionare un percorso e un nome di destinazione per il modulo MDL esportato e viene visualizzata la finestra di dialogo <b>Esporta report</b> con l&#39;elenco dei messaggi registrati durante il processo di esportazione.
...
![Percorso di esportazione MDL](exporting-mdl-content.resources/mdl-export-module.png "Percorso di esportazione MDL")
...
![Percorso di esportazione predefiniti MDL](exporting-mdl-content.resources/mdl-export-preset.png "Percorso di esportazione predefiniti MDL")
...
L&#39;esportazione di un archivio del modulo MDL viene eseguita al livello *pacchetto*. Per esportare un archivio del modulo MDL per un determinato pacchetto, fare clic sul pulsante ![](exporting-mdl-content.resources/mdl-export-module-icon.png) <b>Esporta archivio moduli MDL</b> in [Esplora risorse](../../interface/the-explorer-window/the-explorer-window.md) oppure selezionare la stessa opzione nel menu di scelta rapida del *pacchetto*. Selezionare un percorso e un nome di destinazione per l&#39;archivio del modulo MDL esportato e viene visualizzata la finestra di dialogo <b>Esporta report</b> con l&#39;elenco dei messaggi registrati durante il processo di esportazione.
...
![Percorso di esportazione MDR](exporting-mdl-content.resources/mdl-export-archive.png "Percorso di esportazione MDR")
...
![Percorso di esportazione MDLE](exporting-mdl-content.resources/mdl-export-encapsulated.png "Percorso di esportazione MDLE")
