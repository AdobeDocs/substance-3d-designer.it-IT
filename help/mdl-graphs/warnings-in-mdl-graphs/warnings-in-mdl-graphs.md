...
>[!NOTE]
>
> Le illustrazioni in questa sezione sono state registrate in <b>grafici di modelli Substance</b>, *ritirati* nella versione <b>13.0.0</b> di Substance 3D Designer. Tuttavia, si applicano anche ai grafici MDL.

## ![(errore)](warnings-in-mdl-graphs.resources/error.svg) Nessun nodo di output definito

Nessun nodo di output definito per il grafico.

<b>![(tick)](warnings-in-mdl-graphs.resources/check.svg) Soluzione</b>
...
Il nodo di output di un grafico del modello Substance è colorato in *arancione*.

![&#39;Nessun nodo di output definito&#39; soluzione](warnings-in-mdl-graphs.resources/warnings-model-output.gif "&#39;Nessun nodo di output definito&#39; soluzione")

### ![(errore)](warnings-in-mdl-graphs.resources/error.svg) Almeno un valore di input è stato rifiutato
...
![&#39;Almeno un valore di input è stato rifiutato&#39; soluzione](warnings-in-mdl-graphs.resources/warnings-model-rejected-value.gif "&#39;Almeno un valore di input è stato rifiutato&#39; soluzione")

### ![(errore)](warnings-in-mdl-graphs.resources/error.svg) Nessun valore di input
...
![&#39;Nessun valore di input&#39; soluzione](warnings-in-mdl-graphs.resources/warnings-model-no-input-value.gif "&#39;Nessun valore di input&#39; soluzione")

### Nodo ![(errore)](warnings-in-mdl-graphs.resources/error.svg) non calcolato
...
![&#39;Nodo non calcolato&#39; soluzione](warnings-in-mdl-graphs.resources/warnings-model-no-input-value.gif "&#39;Nodo non calcolato&#39; soluzione")

### ![(errore)](warnings-in-mdl-graphs.resources/error.svg) I dati a cui si fa riferimento contengono alcuni avvisi
...
![&#39;I dati a cui si fa riferimento contengono alcuni avvisi&#39; soluzione](warnings-in-mdl-graphs.resources/warnings-model-referenced-data.gif "&#39;I dati a cui si fa riferimento contengono alcuni avvisi&#39; soluzione")

### ![(errore)](warnings-in-mdl-graphs.resources/error.svg) Risorsa di riferimento non trovata
...
![&#39;Risorsa di riferimento non trovata&#39; soluzione](warnings-in-mdl-graphs.resources/warnings-model-referenced-resource.gif "&#39;Risorsa di riferimento non trovata&#39; soluzione")

### L&#39;intervallo soft ![(error)](warnings-in-mdl-graphs.resources/error.svg) non contiene il valore
...
![&#39;L&#39;intervallo soft non contiene il valore&#39; soluzione](warnings-in-mdl-graphs.resources/warnings-model-ranges.gif "&#39;L&#39;intervallo soft non contiene il valore&#39; soluzione")

### ![(error)](warnings-in-mdl-graphs.resources/error.svg) Intervallo sfumato non compreso nell&#39;intervallo consentito
...
![&#39;L&#39;intervallo soft non è compreso nell&#39;intervallo hard&#39; soluzione](warnings-in-mdl-graphs.resources/warnings-model-ranges.gif "&#39;L&#39;intervallo soft non è compreso nell&#39;intervallo hard&#39; soluzione")

### Il valore ![(error)](warnings-in-mdl-graphs.resources/error.svg) non è compreso nell&#39;intervallo consentito
...
![&#39;Il valore non è compreso nell&#39;intervallo&#39; soluzione](warnings-in-mdl-graphs.resources/warnings-model-ranges.gif "&#39;Il valore non è compreso nell&#39;intervallo&#39; soluzione")
