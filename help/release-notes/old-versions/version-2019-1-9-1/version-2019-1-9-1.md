...
* **Flood Fill all&#39;indice**\
  ...
  Nell’esempio seguente, il nodo Processore pixel effettua la corrispondenza tra l’Input valore e la forma e genera una maschera di conseguenza.

  ![](../../../assets/flood-fill-index-optim.gif)
* **Non Uniform Directional Warp**\
  Applica un’alterazione direzionale in cui intensità e angolo sono campionati dagli input dell’immagine.
...
* **Height Extrude**\
  Genera un rendering ortogonale 3D del Height specificato. La vista della telecamera può essere controllata con il gizmo posizione.
