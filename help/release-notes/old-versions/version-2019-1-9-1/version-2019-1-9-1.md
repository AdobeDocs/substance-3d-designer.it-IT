...
Se desideri disattivare uno dei due backend, passa alle preferenze principali (**Modifica > Preferenze**) e alle impostazioni dei panettieri:
...
Questo miglioramento delle prestazioni avrà effetto sia sui forni che sulla vista 3D.
...
Nella libreria predefinita sono inoltre disponibili alcuni nuovi nodi, alcuni dei quali sono ora alimentati con il nuovo nodo Processore di valore:
