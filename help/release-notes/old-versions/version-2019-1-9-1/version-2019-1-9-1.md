...
### Nuovo nodo Processore di valori

![](../../../assets/doc-value-processor.png)

La Substance Engine è ora nella versione 7 e con essa porta il nuovo concetto di &quot;Valori&quot; all&#39;interno del grafico di composizione. I valori sono numeri e non texture e come tali possono essere utilizzati per eseguire vari calcoli che possono essere condivisi tra nodi tramite i grafici delle funzioni e i grafici di composizione. Il nodo di Processore di valori può leggere un&#39;immagine di input e calcolare un singolo valore di output.

Il nodo del Processore di valori non è l&#39;unico, per consentire il transito delle informazioni sul grafico sono state apportate alcune modifiche e aggiunte:
...
### Supporto di Optix in Baker

![](../../../assets/baking-speed.jpg)

L&#39;ultimo aggiornamento del Substance Designer ha introdotto l&#39;DXR che permette di eseguire il Raytracing GPU su hardware compatibile RTX compatibile. Ora abbiamo aggiunto il supporto per [Optix](https://developer.nvidia.com/optix) che consente di eseguire raytrace su altre GPU Nvidia anche in Linux. Se si utilizza Optix, è possibile eseguire i baking almeno **5 volte più velocemente** rispetto al normale raytracing della CPU.

Di seguito è riportato l&#39;elenco dei Baker interessati dalla modifica:
