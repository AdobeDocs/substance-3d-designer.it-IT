...
* **Dispersione sottosuperficie**\
  ...
  * **dispersione**: controlla l’intensità della diffusione della luce all’interno del materiale.
  ...
  Nota: Subsurface richiede il nuovo shader &quot;physically\_metallic\_roughness\_sss&quot; . Il colore di dispersione può essere controllato nei parametri di shader.

  ![](../../../assets/sub-surface-scattering-0.jpg){width="400px"}

>[!NOTE]
>
> Tutte queste nuove funzioni di rendering sono possibili grazie a una rielaborazione del Substance Designer di shader. Il formato **GLSLFX** ora supporta la definizione di &quot;**Tecniche**&quot; che consente il passaggio multiplo del rendering. Per alcuni esempi, dai un&#39;occhiata ai nostri shader predefiniti disponibili in: **Substance Designer/risorse/view3d/shaders**
...
### Nuovi contenuti con i filtri HDR

![](../../../assets/header-hdr-filters.jpg)

Con questa nuova versione vengono introdotti molti nuovi filtri dedicati alla manipolazione delle mappe ambientali dell’HDR.
...
* **Nadir extract**: questo nodo è in grado di estrarre una texture da un&#39;immagine HDRI. Può essere utilizzato per mappare una texture terreno in una scena 3D.
...
* **Luce piana**: genera una luce rettangolare come se fosse una forma 3D. Potete cambiarne la posizione nel Vista 2D, applicare una texture e impostare il colore usando un valore di temperatura o RGB.
...
* [Content] Nuovo filtro &quot;HDR Merge&quot;
