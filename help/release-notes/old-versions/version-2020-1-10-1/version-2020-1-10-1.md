...
**Substance Designer 2020.1** include un nuovo editor di scelte rapide, un plug-in MaterialX e molti nuovi miglioramenti per la gestione del colore, con Adobi Color Engine e nuove funzionalità dei panettieri.
...
### Nuovo editor scelte rapide per la creazione di nodi

![](version-2020-1-10-1.resources/banner-shortcuts.png)

In questa versione introduciamo un nuovo editor di scelte rapide che consente di definire le scelte rapide da tastiera per velocizzare la creazione di nodi nelle diverse modalità del grafico.

Il nuovo editor scelte rapide è accessibile nelle preferenze principali tramite **Modifica > Preferenze > Scelte rapide**. Per impostazione predefinita, ogni campo collegamento è vuoto.

* **Scelte rapide per ogni tipo di grafico**\
  È possibile definire una scelta rapida per ogni tipo di grafico disponibile in Substance Designer, dal normale grafico di composizione a quello più avanzato come funzioni e MDL.
...
* **Creazione di un nuovo collegamento**\
  Per creare una nuova scelta rapida per un nodo specifico, è sufficiente fare clic nel campo di testo accanto al nome e digitare i tasti richiesti sulla tastiera. Per eliminare una scelta rapida, utilizza il pulsante x.
...
* Sviluppate ombre procedurali e texture in parallelo.
* Crea ombreggiature avanzate per la Substance Painter con funzionalità come mappe di dettaglio e maschere procedurali modificabili in fase di runtime.
* Corrispondenza delle funzionalità dello shader da un motore di gioco o da una pipeline VFX nella finestra della vista Substance Designer e Substance Painter.

Per ottenere il plug-in, passa a [Substance share](https://share.substance3d.com/libraries/6111) per scaricarlo.

### Nuova integrazione dell&#39;Adobe Color Engine (ACE)

![](version-2020-1-10-1.resources/banner-ace-1.jpg)

Oltre a OpenColorIO, ora è possibile utilizzare l&#39;Adobe Color Engine (ACE) per supportare i profili ICC per la gestione del colore. Ciò significa che ora è possibile importare ed esportare immagini calibrate in modo che corrispondano ad altri software come Photoshop e Illustrator.
...
* **ACES per la gestione dei colori precedente**\
  La trasformazione dell’output con mappatura tonale ACES è ora disponibile con la modalità di gestione colore legacy.
