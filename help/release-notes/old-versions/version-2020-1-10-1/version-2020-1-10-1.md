...
* **Nuovo filtro FXAA**\
  Il nuovo filtro implementa l’algoritmo Fast Approssimate Anti-Aliasing (FXAA), un metodo di anti-alias. Può essere utilizzato su texture regolare per uniformare linee o bordi irregolari.\
