...
* **Supporto USD** Oltre al
  ...
  formati di file, è ora possibile importare ed esportare i file USD (
...
* Abbiamo anche aggiunto alcuni nuovi nodi di gestione delle scene per i grafici dei modelli Substance. Questi nodi consentono di rinominare, modificare il nome, fondere o espandere gli elementi della scena per organizzare la gerarchia delle scene. È inoltre disponibile un nuovo nodo per impostare il perno di uno o più elementi di una scena.
