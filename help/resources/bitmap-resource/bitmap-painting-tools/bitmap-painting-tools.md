...
breadcrumb-title: ''
description: Utilizzate gli strumenti di pittura bitmap in Substance 3D Designer per disegnare direttamente sulle risorse bitmap per la modifica delle texture.
...
![Strumenti di pittura bitmap nella vista 2D](../../../assets/2dview-paintingtools-main_1.png "Strumenti di pittura bitmap nella vista 2D"){width="512px"}
...
* Nel pannello [Esplora risorse](https://helpx.adobe.com/it/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html), fate clic su RMB in un *pacchetto SBS* o in una *cartella* all&#39;interno di un pacchetto per aprire il relativo menu di scelta rapida, quindi aprite il sottomenu <b>Nuovo</b> e selezionate l&#39;opzione <b>Bitmap</b>
...
<b>Importa i predefiniti della libreria:</b> *carica* da un file di libreria esistente e *aggiungili* all&#39;elenco corrente: i predefiniti con *lo stesso nome vengono sostituiti* da quelli del file di libreria

<b>Reimposta libreria:</b> reimposta i predefiniti correnti in base alla libreria predefinita

<b>Sostituisci i predefiniti della libreria:</b> *carica* da un file di libreria esistente e *annulla* l&#39;elenco corrente
...
+++Colore
Il colore applicato dal pennello è definito dal *colore primario selezionato* e dalla <b>texture pennello</b>, se ne è attualmente applicata una. Questo colore può essere modificato dinamicamente utilizzando i controlli di questa sezione.
...
Gli strumenti Pennello, Timbro e Gomma consentono inoltre di impostare i ![](../../../assets/2dview-paintingtools-icon-tiling.png) <b>Metodi di porzione</b>, che ne definiscono la capacità di *scorrere all&#39;indietro* sul lato opposto dell&#39;immagine quando un tratto influisce su un&#39;area al di fuori dei limiti dell&#39;immagine:

<b>Divisione in porzioni X e Y</b>: sezione dei tratti pennello *sia in orizzontale che in verticale*

<b>Divisione in porzioni X</b>: porzione dei tratti pennello *solo in orizzontale*

<b>Affiancatura Y</b>: riquadro tratti pennello *solo verticalmente*

<b>Nessuna suddivisione</b>: i tratti pennello *non suddividono*

</td>
<td width="25.00%" style="border: 0;" valign="top">

![Modalità porzione](../../../assets/2dview-paintingtools-tiling.png "Modalità porzione")
